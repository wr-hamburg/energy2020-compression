! This test uses the SCIL API to set the precision for HDF5 compression and uses the HDF5 compression
!
! Test is derived from HDF5 fortran/examples/h5_cmprss.f90, see the following license:
! * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
PROGRAM h5_cmprss
  ...
  ! CALL SCIL function
  print *, "Property Fortran: ", plist_id
  CALL h5pset_scil_compression_hints_f(plist_id, SCIL_ACCURACY_DBL_IGNORE, SCIL_ACCURACY_DBL_IGNORE, &
    SCIL_ACCURACY_DBL_IGNORE, SCIL_ACCURACY_INT_IGNORE, SCIL_ACCURACY_INT_IGNORE)
